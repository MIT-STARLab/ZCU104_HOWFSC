...
/**
 * @brief Shifts the zero-frequency component to the center of a 2D complex array.
 *
 * This function rearranges a 2D complex array stored in row-major order.
 * It's assumed that the dimensions (M, N) are both even. This function swaps the quadrants of the array to move the
 * low-frequency components to the center of the spectrum.
 *
 * @param arr Pointer to the first element of the complex array.
...
/**
 * @brief Reverses the effect of fftshift, shifting the zero-frequency component back to the original position.
 *
 * This function rearranges a 2D complex array similarly to fftshift, intended to reverse the shift applied by fftshift.
 * The array format and indexing method are the same as for fftshift.
 * The function is suitable for arrays with even dimensions and restores the original layout of the frequency components.
 *
 * @param arr Pointer to the first element of the complex array.
 * @param M Number of rows in the array.
 * @param N Number of columns in the array.
